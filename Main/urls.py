...
urlpatterns = [
    ...
    path('dashboard/edituser', views.dashboard_editProfile, name='edituser'),
    path('dashboard/users', views.UsersListView.as_view(), name='users'),
    ...
    path('dashboard/reports/',views.ReportListView.as_view(),name='reports'),
