# Generated by Django 2.2.4 on 2019-08-06 10:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ManyToManyField(default='ok', related_name='posts', to='Main.Tags')),
            ],
            options={
                'ordering': ('-upvote',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('promotion', models.CharField(choices=[('1cpi', '1CPI'), ('2cpi', '2CPI'), ('1cs', '1CS'), ('2cs', '2CS'), ('3cs', '3CS')], default='1cpi', max_length=3, null=True)),
                ('bio', models.TextField(null=True)),
                ('slug', models.SlugField(max_length=250, null=True, unique=True)),
                ('image', models.ImageField(null=True, upload_to='')),
                ('is_appoved', models.BooleanField(default=False)),
                ('publication_enregistrer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='Main.Publication')),
